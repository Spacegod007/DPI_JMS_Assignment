...
public class StaticNames
{
    ...
    public static final String ABN_AMRO_NAME = "Abn Amro";
    ...
    public static final String ING_BANK_DESTINATION = "bank.ing";
    public static final String RABOBANK_BANK_DESTINATION = "bank.rabobank";
