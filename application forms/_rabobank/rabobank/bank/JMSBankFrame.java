...
import rabobank.bank.gateway.LoanBrokerGateway;
...
public class JMSBankFrame extends JFrame {
	...
	{
		setTitle("JMS Bank - " + StaticNames.RABOBANK_NAME);
		...
		btnSendReply.addActionListener(e -> {
			...
			BankInterestReply reply = new BankInterestReply(interest,StaticNames.RABOBANK_NAME);
