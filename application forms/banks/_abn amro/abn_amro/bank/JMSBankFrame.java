...
import abn_amro.bank.gateway.LoanBrokerGateway;
...
public class JMSBankFrame extends JFrame {
	...
	{
		setTitle("JMS Bank - " + StaticNames.ABN_AMRO_NAME);
		...
		btnSendReply.addActionListener(e -> {
			...
			BankInterestReply reply = new BankInterestReply(interest, StaticNames.ABN_AMRO_NAME);
